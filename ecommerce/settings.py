...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'django.template.context_processors.request',  # 1stly required by allauth
...
if 'USE_AWS' in os.environ:
    # BUCKET CONFIG
    AWS_STORAGE_BUCKET_NAME = 'boss-ecommerce'
...
DEFAULT_FROM_EMAIL = 'bossmanboutique@example.com'
